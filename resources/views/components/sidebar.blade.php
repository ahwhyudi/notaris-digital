        ...
        <ul class="space-y-2">
            <li>
                <a href="{{ route('components.index') }}"
                    ...
                    <svg class="w-6 h-6 text-gray-400 transition dark:text-gray-400 group-hover:text-gray-900 dark:hover:bg-gray-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
